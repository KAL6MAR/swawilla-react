...
import ItemAmmountButton from "../ItemsPage/ItemAmmountButton";
        ...
        <div>
            <div className='row '>
                <div className='row items align-items-center'>
                    ...
                    <div className='col'>
                        <div className='cart__item-count d-flex justify-content-between'>
                            <div
                                onClick={handleMinusItem}
                                className='button button--outline button--circle card__item-count-minus'
                            >
                                <svg
                                    width='10'
                                    height='10'
